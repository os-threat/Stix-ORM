...
class TestParseObject:
    ...
    def import_type(self):
        return import_type_factory.get_default_import()

    def test_dict_to_stix(self, import_type):
        stix_dict = {
            'type': 'identity',
            'spec_version': '2.1',
        ...
        result = dict_to_stix(stix_dict, allow_custom=False, import_type=import_type)
    ...
    def test_dict_to_stix_2(self, import_type):
        obj = {
            'type': 'relationship',
            'spec_version': '2.1',
        ...
        result = dict_to_stix(obj, allow_custom=False, import_type=import_type)
